...
<div class="colr"><table style="margin-left:0px; margin-right: 0px;"><tr>
  <th style="background-color: white;color:blue; ">Attempt</th>
  </tr><tr><th style="background-color: white; color:red;">Not Attempt</th>
  </tr></table></div>
</div>
...
var total_second=15*60;
 var c_minute=parseInt(total_second/60);
 var c_second=parseInt(total_second%60);
 function checktime()
   {
      document.getElementById("timer").innerHTML=c_minute +'min' + " "+c_second +'sec';
      if(total_second<=0)
      {
           window.alert("Your Time Is Finish and and form has been submited successfully");
           document.getElementById("sonu").submit();              
       }
      else
      {
